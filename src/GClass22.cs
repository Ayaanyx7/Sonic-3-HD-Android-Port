...
public class GClass22 : GClass0
{
	...
	private void method_5()
	{
		...
		GClass22 gClass = this;
		gClass.vector2_0.X = gClass.vector2_0.X + vector2_1.X;
		GClass22 gClass2 = this;
		gClass2.vector2_0.Y = gClass2.vector2_0.Y + vector2_1.Y;
	...
	{
		return method_13(int_35, int_36, false, true);
	}

	private float method_12(int int_35, int int_36, bool bool_19)
	{
		return method_13(int_35, int_36, bool_19, true);
	}
	...
	{
		return method_16(int_35, int_36, false, true);
	}

	private float method_15(int int_35, int int_36, bool bool_19)
	{
		return method_16(int_35, int_36, bool_19, true);
	}
	...
	{
		return method_19(int_35, int_36, false, true);
	}

	private float method_18(int int_35, int int_36, bool bool_19)
	{
		return method_19(int_35, int_36, bool_19, true);
	}
	...
	public void method_22(int int_35)
	{
		...
		{
			GClass22 gClass = this;
			gClass.vector2_1.Y = gClass.vector2_1.Y - (float)Math.Sign(vector2_1.Y);
		}
	...
	private void method_25()
	{
		...
		case (GEnum0)0:
			...
			{
				num4 = (float_18 = method_13(num - 36, int_, false, false));
				num5 = (float_19 = method_13(num + 36, int_, false, false));
			...
			if (float_18 < 80f || float_19 < 80f || num2 < 80f || num3 < 80f)
			{
				if (genum3_0 == (GEnum3)0)
				{
					...
					{
						float_14 = method_12(num - 36, int_, true);
					}
					else
					{
						float_14 = (float_14 = method_12(num + 36, int_, true));
					}
				}
				if (genum3_0 == (GEnum3)1)
				{
					if (float_18 < float_19)
					{
						float_14 = method_13(num - 36, int_, true, false);
					}
					else
					{
						float_14 = (float_14 = method_13(num + 36, int_, true, false));
					}
				}
				if (genum3_0 == (GEnum3)2)
				{
		...
		case (GEnum0)1:
			...
			method_15(num, int_, true);
			if (genum3_0 == (GEnum3)0 || genum3_0 == (GEnum3)2)
			{
				method_15(num, int_ - 36, true);
			...
			if (genum3_0 == (GEnum3)1 || genum3_0 == (GEnum3)2)
			{
				method_16(num, int_ - 36, true, false);
		...
		case (GEnum0)2:
			...
			if (genum3_0 == (GEnum3)0 || genum3_0 == (GEnum3)2)
			{
				method_18(num, int_, true);
				num2 = (float_18 = method_17(num - 32, int_));
				num3 = (float_19 = method_17(num + 32, int_));
			}
			if (genum3_0 == (GEnum3)1 || genum3_0 == (GEnum3)2)
			{
				method_19(num, int_, true, true);
				num4 = (float_18 = method_19(num - 32, int_, false, false));
				num5 = (float_19 = method_19(num + 32, int_, false, false));
			...
			if (genum3_0 == (GEnum3)0)
			{
				if (num2 > num3)
				{
					float_16 = method_19(num - 32, int_, true, true);
				}
				else
				{
					float_16 = method_19(num + 32, int_, true, true);
			...
			if (genum3_0 == (GEnum3)1)
			{
				if (float_18 > float_19)
				{
					float_14 = (float_16 = method_19(num - 32, int_, true, false));
				}
				else
				{
					float_14 = (float_16 = method_19(num + 32, int_, true, false));
			...
			if ((num2 >= num4 && !(num2 < num5)) || (num3 >= num4 && num3 >= num5))
			{
				if (num2 > num3)
				{
					float_16 = method_18(num - 32, int_, true);
				}
				else
				{
					float_16 = method_18(num + 32, int_, true);
			...
			{
				float_16 = method_19(num - 32, int_, true, false);
			}
			else
			{
				float_16 = method_19(num + 32, int_, true, false);
		...
		case (GEnum0)3:
			...
			if (genum3_0 == (GEnum3)1)
			{
				if (float_18 > float_19)
				{
					float_14 = method_16(num, int_ - 36, true, false);
				}
				else
				{
					float_14 = (float_14 = method_16(num, int_ + 36, true, false));
				}
			}
			if (genum3_0 != (GEnum3)2)
			{
		...
		case (GEnum0)4:
		{
			...
			if (genum3_0 == (GEnum3)1 || genum3_0 == (GEnum3)2)
			{
				float_14 = method_13(num, int_, false, false);
				float_18 = method_13(num - 36, int_, false, false);
				float_19 = method_13(num + 36, int_, false, false);
				if (float_14 < num6)
				{
					if (float_18 < 80f || float_19 < 80f)
					{
	...
	private void method_26()
	{
		...
		case (GEnum0)0:
			...
			if (genum3_0 == (GEnum3)1 || genum3_0 == (GEnum3)2)
			{
				method_16(num, num2 - 64, false, false);
			}
			...
			if (float_15 < 44f)
			{
				if (genum3_0 == (GEnum3)0)
				{
					float_18 = method_13(num + 16 - 36, num2, false, false);
					float_19 = method_13(num + 16 + 36, num2, false, false);
	...
	private void method_29()
	{
		...
		case (GEnum0)0:
			if (float_14 >= 0f && vector2_1.Y >= 0f)
			{
				if (float_14 <= 80f)
				{
					vector2_1.Y = 0f;
					GClass22 gClass = this;
					gClass.vector2_0.Y = gClass.vector2_0.Y + float_14;
				}
				else
				{
					vector2_1.Y = 0f;
			...
			{
				GClass22 gClass2 = this;
				gClass2.vector2_0.Y = gClass2.vector2_0.Y + float_14;
			}
			break;
		}
		if (int_6 == 0 && int_7 == 0)
		...
		{
			genum4_0 = (GEnum4)3;
			GClass22 gClass3 = this;
			gClass3.vector2_1.X = gClass3.vector2_1.X + 26f * (float)Math.Sin(float_20);
			GClass22 gClass4 = this;
			gClass4.vector2_1.Y = gClass4.vector2_1.Y - 26f * (float)Math.Cos(float_20);
			bool_6 = false;
			bool_5 = true;
	...
	private void method_30()
	{
		...
		if (int_10 == 1 || int_11 == 1 || int_12 == 1)
		{
			genum4_0 = (GEnum4)3;
			GClass22 gClass = this;
			gClass.vector2_1.X = gClass.vector2_1.X + 26f * (float)Math.Sin(float_20);
			GClass22 gClass2 = this;
			gClass2.vector2_1.Y = gClass2.vector2_1.Y + -26f * (float)Math.Cos(float_20);
			bool_5 = true;
			GClass30.soundEffect_22.Play(GClass30.float_0, 0f, 0f);
		}
		switch (genum0_0)
		...
		case (GEnum0)0:
			if (float_14 >= 0f && vector2_1.Y >= 0f)
			{
				...
				{
					vector2_1.Y = 0f;
					GClass22 gClass9 = this;
					gClass9.vector2_0.Y = gClass9.vector2_0.Y + float_14;
				}
				else
				{
					vector2_1.Y = 0f;
			...
			{
				GClass22 gClass10 = this;
				gClass10.vector2_0.Y = gClass10.vector2_0.Y + float_14;
			}
			break;
		case (GEnum0)1:
			if (float_15 >= 0f && (double)vector2_1.X >= -0.1)
			{
				...
				{
					vector2_1.X = 0f;
					GClass22 gClass7 = this;
					gClass7.vector2_0.X = gClass7.vector2_0.X + float_15;
				}
				else
				{
					vector2_1.X = 0f;
			...
			{
				GClass22 gClass8 = this;
				gClass8.vector2_0.X = gClass8.vector2_0.X + float_15;
			}
			break;
		case (GEnum0)2:
			if (float_16 <= 0f && vector2_1.Y <= 0f)
			{
				...
				{
					vector2_1.Y = 0f;
					GClass22 gClass5 = this;
					gClass5.vector2_0.Y = gClass5.vector2_0.Y + float_16;
				}
				else
				{
					vector2_1.Y = 0f;
			...
			{
				GClass22 gClass6 = this;
				gClass6.vector2_0.Y = gClass6.vector2_0.Y + float_16;
			}
			if (float_16 < -80f)
			{
				vector2_1.Y = 0f;
		...
		case (GEnum0)3:
			if (float_17 <= 0f && (double)vector2_1.X <= 0.1)
			{
				if (float_17 >= -80f)
				{
					vector2_1.X = 0f;
					GClass22 gClass3 = this;
					gClass3.vector2_0.X = gClass3.vector2_0.X + float_17;
				}
				else
				{
					vector2_1.X = 0f;
			...
			{
				GClass22 gClass4 = this;
				gClass4.vector2_0.X = gClass4.vector2_0.X + float_17;
			}
			break;
		}
	...
	private void method_33()
	{
		if (int_6 > 0)
		{
			bool_0 = false;
			GClass22 gClass = this;
			gClass.vector2_1.X = gClass.vector2_1.X - float_8;
		}
		if (int_7 > 0)
		{
			bool_0 = true;
			GClass22 gClass2 = this;
			gClass2.vector2_1.X = gClass2.vector2_1.X + float_8;
		}
		...
		{
			GClass22 gClass3 = this;
			gClass3.vector2_0.Y = gClass3.vector2_0.Y + (0f - float_16 + 4f);
			vector2_1.Y = 0f;
		}
		...
		{
			GClass22 gClass4 = this;
			gClass4.vector2_1.X = gClass4.vector2_1.X * (31f / 32f);
		}
		GClass22 gClass5 = this;
		gClass5.vector2_1.Y = gClass5.vector2_1.Y + float_9;
		GClass22 gClass6 = this;
		gClass6.vector2_0.X = gClass6.vector2_0.X + vector2_1.X;
		GClass22 gClass7 = this;
		gClass7.vector2_0.Y = gClass7.vector2_0.Y + vector2_1.Y;
		method_26();
		method_25();
		if (float_14 > -64f && float_14 <= 0f && vector2_1.Y >= 0f)
		{
			...
			vector2_1.Y = 0f;
			GClass22 gClass8 = this;
			gClass8.vector2_0.Y = gClass8.vector2_0.Y + float_14;
			genum4_0 = (GEnum4)1;
	...
	private void method_34()
	{
		...
		{
			GClass22 gClass3 = this;
			gClass3.vector2_1.X = gClass3.vector2_1.X * (31f / 32f);
		}
		GClass22 gClass4 = this;
		gClass4.vector2_1.Y = gClass4.vector2_1.Y + float_9;
		GClass22 gClass5 = this;
		gClass5.vector2_0.X = gClass5.vector2_0.X + vector2_1.X;
		GClass22 gClass6 = this;
		gClass6.vector2_0.Y = gClass6.vector2_0.Y + vector2_1.Y;
		method_26();
		method_25();
		...
		{
			GClass22 gClass7 = this;
			gClass7.vector2_0.Y = gClass7.vector2_0.Y - (float_16 + 160f);
			vector2_1.Y = 0f;
		}
		if (float_14 > -64f && float_14 <= 0f && vector2_1.Y >= 0f)
		{
	...
	private void method_35()
	{
		...
		{
			GClass22 gClass7 = this;
			gClass7.vector2_0.Y = gClass7.vector2_0.Y + (0f - float_16 + 4f);
			vector2_1.Y = 0f;
		}
		method_26();
		method_25();
		...
		{
			GClass22 gClass8 = this;
			gClass8.vector2_0.Y = gClass8.vector2_0.Y - (float_16 + 120f);
			vector2_1.Y = 0f;
		}
	...
	public override void Update()
	{
		...
		case (GEnum4)7:
			...
			else if (int_10 == 1 || int_11 == 1 || int_12 == 1)
			{
				genum4_0 = (GEnum4)3;
				GClass22 gClass6 = this;
				gClass6.vector2_1.X = gClass6.vector2_1.X - -26f * (float)Math.Sin(float_20);
				GClass22 gClass7 = this;
				gClass7.vector2_1.Y = gClass7.vector2_1.Y - 26f * (float)Math.Cos(float_20);
				bool_5 = true;
				GClass30.soundEffect_22.Play(GClass30.float_0, 0f, 0f);
			}
			break;
		...
		case (GEnum4)11:
		{
			...
			{
				GClass22 gClass = this;
				gClass.vector2_1.X = gClass.vector2_1.X * (31f / 32f);
			}
			GClass22 gClass2 = this;
			gClass2.vector2_1.Y = gClass2.vector2_1.Y + 0.75f;
			GClass22 gClass3 = this;
			gClass3.vector2_0.X = gClass3.vector2_0.X + vector2_1.X;
			GClass22 gClass4 = this;
			gClass4.vector2_0.Y = gClass4.vector2_0.Y + vector2_1.Y;
			method_25();
			method_26();
			if (float_14 > -64f && float_14 <= 0f && vector2_1.Y >= 0f)
			{
				...
				vector2_1.Y = 0f;
				GClass22 gClass5 = this;
				gClass5.vector2_0.Y = gClass5.vector2_0.Y + float_14;
				genum4_0 = (GEnum4)1;
				int_5 = 120;
			}
			else
		...
		case (GEnum4)12:
		{
			...
			GClass22 gClass8 = this;
			gClass8.vector2_1.Y = gClass8.vector2_1.Y + float_9;
			if (!(float_27 > 1000f))
			{
				break;
			}
