...
public class GClass29
{
	...
	public GClass29(GClass25 gclass25_1)
	{
		...
		if (GClass25.stopwatch_0.IsRunning)
		{
			...
			window.Title = string.Concat(title, "  Loading time: ", GClass25.stopwatch_0.Elapsed.Seconds, ".", GClass25.stopwatch_0.Elapsed.Milliseconds, " seconds   pre tech demo build 99");
	...
	private void method_1()
	{
		...
		if (bool_1)
		{
			if (gclass25_0.int_7 == 1)
			{
				...
				int num6 = gclass24_0.int_2[int_3, int_2];
			}
			if (gclass25_0.int_8 == 1)
			{
				...
				int num7 = gclass24_0.int_2[int_3, int_2];
			}
	...
	public void method_2()
	{
		...
		for (int i = 0; i < gclass22_0.Length; i++)
		{
			...
			for (int j = 0; j < gclass24_0.gclass0_0.Length; j++)
			{
				...
				if (gClass != null)
				{
					gClass.vmethod_0(gclass22_0[i]);
				}
			}
		}
		for (int i = 0; i < gclass24_0.gclass0_0.Length; i++)
		{
			GClass0 gClass = gclass24_0.gclass0_0[i];
			if (gClass != null)
			{
				gClass.Update();
			}
		...
		if (gclass22_0[0].vector2_0.X > num)
		{
			...
			{
				GClass29 gClass2 = this;
				gClass2.vector2_0.X = gClass2.vector2_0.X + 64f;
			}
			else
			{
				GClass29 gClass3 = this;
				gClass3.vector2_0.X = gClass3.vector2_0.X + (gclass22_0[0].vector2_0.X - num);
			}
		}
		else if (gclass22_0[0].vector2_0.X < num - 64f)
		{
			...
			{
				GClass29 gClass4 = this;
				gClass4.vector2_0.X = gClass4.vector2_0.X - 64f;
			}
			else
			{
		...
		else if (gclass22_0[0].bool_10)
		{
			if (Math.Abs(gclass22_0[0].vector2_1.Y) > 48f)
			{
				if (num2 - 64f < (float)num4)
				{
					...
					{
						GClass29 gClass5 = this;
						gClass5.vector2_0.Y = gClass5.vector2_0.Y + 64f;
					}
					else
					{
				...
				if (num2 - 64f > (float)num4)
				{
					if (num2 - 64f - 64f > (float)num4)
					{
						GClass29 gClass6 = this;
						gClass6.vector2_0.Y = gClass6.vector2_0.Y - 64f;
					}
					else
					{
						vector2_0.Y = num4 + 64 - ((Texture2D)gclass25_0.renderTarget2D_0).Height / 2;
			...
			else
			{
				if (num2 - 64f < (float)num4)
				{
					...
					{
						GClass29 gClass7 = this;
						gClass7.vector2_0.Y = gClass7.vector2_0.Y + 24f;
					}
					else
					{
						vector2_0.Y = num4 + 64 - ((Texture2D)gclass25_0.renderTarget2D_0).Height / 2;
				...
				if (num2 - 64f > (float)num4)
				{
					if (num2 - 64f - 24f > (float)num4)
					{
						GClass29 gClass8 = this;
						gClass8.vector2_0.Y = gClass8.vector2_0.Y - 24f;
					}
					else
					{
						vector2_0.Y = num4 + 64 - ((Texture2D)gclass25_0.renderTarget2D_0).Height / 2;
		...
		else if (!(num2 - 192f <= (float)num4) || !((float)num4 <= num2 + 64f))
		{
			if (num2 - 192f > (float)num4)
			{
				...
				{
					GClass29 gClass9 = this;
					gClass9.vector2_0.Y = gClass9.vector2_0.Y - 64f;
				}
				else
				{
			...
			{
				GClass29 gClass10 = this;
				gClass10.vector2_0.Y = gClass10.vector2_0.Y + 64f;
			}
			else
			{
				vector2_0.Y = num4 - 64 - ((Texture2D)gclass25_0.renderTarget2D_0).Height / 2;
	...
	public void method_3()
	{
		...
		if ((bool_0 && !bool_2) || !bool_0)
		{
			...
			GClass29 gClass = this;
			gClass.vector2_1.X = gClass.vector2_1.X + (float)gclass24_0.texture2D_1.Width;
			gclass25_0.spriteBatch_0.Draw(gclass24_0.texture2D_1, vector2_1, color_0);
			GClass29 gClass2 = this;
			gClass2.vector2_1.X = gClass2.vector2_1.X + (float)gclass24_0.texture2D_1.Width;
			gclass25_0.spriteBatch_0.Draw(gclass24_0.texture2D_1, vector2_1, color_0);
			GClass29 gClass3 = this;
			gClass3.vector2_1.X = gClass3.vector2_1.X + (float)gclass24_0.texture2D_1.Width;
			gclass25_0.spriteBatch_0.Draw(gclass24_0.texture2D_1, vector2_1, color_0);
		...
		if ((bool_0 && !bool_2) || !bool_0)
		{
			...
			for (int j = 0; j < gclass24_0.gclass0_0.Length; j++)
			{
				GClass0 gClass4 = gclass24_0.gclass0_0[j];
				if (gClass4 != null && (gClass4.bool_1 || !gClass4.bool_2))
				{
					gClass4.vmethod_3(gclass24_0.gclass0_0[j].vector2_0 - vector2_0, 1f);
				}
			}
			for (int j = 0; j < gclass22_0.Length; j++)
			{
				GClass0 gClass4 = gclass22_0[j];
				if (gClass4 != null)
				{
					gClass4.vmethod_1();
				}
			...
			{
				GClass0 gClass4 = gclass24_0.gclass0_0[j];
				if (gClass4 != null && gClass4.bool_2)
				{
					gClass4.vmethod_4(gclass24_0.gclass0_0[j].vector2_0 - vector2_0, 1f);
				}
			}
