...
public class GClass18 : GClass0
{
	...
	public override bool vmethod_0(GClass22 gclass22_0)
	{
		...
		{
			ref Vector2 reference = ref array[num2];
			reference = method_3((num * int_2 - num * 2 * num2 - 2 * num2) % (240 * num), vector2_0, 120 * num);
		}
		ref Vector2 reference2 = ref array[7];
		reference2 = method_3((num * int_2 - num * 2 * 7 - 14) % (240 * num), vector2_0, 120 * num);
		ref Vector2 reference3 = ref array[0];
		reference3 = method_2(int_, vector2_0);
