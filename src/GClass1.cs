...
public class GClass1 : GClass0
{
	...
	public override void Update()
	{
		...
		{
			GClass1 gClass = this;
			gClass.vector2_1.Y = gClass.vector2_1.Y + 0.375f;
			vector2_0 += vector2_1;
			method_4();
			if (int_2 > 256)
			{
	...
	{
		return method_3(int_3, int_4, false);
	}
	...
	public void method_4()
	{
		if (!(vector2_1.Y <= 0f))
		{
			...
			{
				GClass1 gClass = this;
				gClass.vector2_1.Y = gClass.vector2_1.Y * -0.75f;
				GClass1 gClass2 = this;
				gClass2.vector2_0.Y = gClass2.vector2_0.Y - num;
			}
		}
	}
